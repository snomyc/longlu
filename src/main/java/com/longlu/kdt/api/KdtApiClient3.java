...
public class KdtApiClient3 {
	private static final String Version = "3.0.0";

    private static final String apiEntry = "https://open.youzan.com/api/entry/";
    ...
    public KdtApiClient3(String appId, String appSecret) throws Exception{
    ...
    public HttpResponse get(String method, HashMap<String,String> parames) throws Exception{
    	...
    	sb.append(apiEntry);
    	sb.append(method.substring(0, method.lastIndexOf("."))).append("/");
    	sb.append(Version).append("/");
    	sb.append(method.substring(method.lastIndexOf(".")+1, method.length())).append("?");
    	sb.append(getParamStr(method, parames));
        String url = sb.toString();
        
        //HttpClient client = new DefaultHttpClient();
        //如果使用HttpClient对象则会报错SSLexception
